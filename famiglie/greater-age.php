<?php
    ...
    if (empty($people)) {
        echo "No person found with age greater than the one provided ({$minAge}).";
        exit;
    }
?>
...
<head>
    ...
    <title>Family Members by Age</title>
    <link href="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css" rel="stylesheet">
</head>
<body>
    <div class="container mt-5">
        <div class="jumbotron text-center">
            <h1 class="display-4">Family Members by Age</h1>
            <p class="lead">List of family members older than <?php echo $minAge; ?> years.</p>
        </div>
